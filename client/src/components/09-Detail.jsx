...
export default function Detail(props) {
	...
	foundCountry = foundCountry.length
		...
		: 0;
	let { Area, Capital, Continente, Imagen, ID, Nombre, Poblacion, Subregion, tourisms } = foundCountry[0]
		? foundCountry[0]
		: "null";
	return (
		<main className="detail">
			...
			<div className="div1">
				...
				<div className="div2">
					...
					<h3>
						&nbsp;Poblacion: {Poblacion ? Poblacion.toLocaleString("en-US") : "No se encontró su Poblacion"} personas.
					</h3>
					<h3>
						&nbsp;Actividades:{" "}
						{tourisms?.length
